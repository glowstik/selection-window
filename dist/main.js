...
function $0d16028b28e5283f$var$SelectionWindow({ children: children , onCropChange: onCropChange , className: className , width: width , height: height , mouseThreshold: mouseThreshold = 20 , touchThreshold: touchThreshold = 45  }, imgWrapperRef) {
    ...
    const imgPointerRef = (0, ($parcel$interopDefault($dSH8u$react))).useRef(null);
    ...
    useGesture({
        onDrag: ({ offset: [dx, dy]  })=>{
            imgWrapperRef.current.style.top = $0d16028b28e5283f$var$px(cropper.y);
            imgWrapperRef.current.style.left = $0d16028b28e5283f$var$px(cropper.x);
    ...
    function adjustImage() {
        ...
        setCropper(newCrop);
        imgWrapperRef.current.style.left = $0d16028b28e5283f$var$px(cropper.x);
        imgWrapperRef.current.style.right = $0d16028b28e5283f$var$px(cropper.x);
        imgWrapperRef.current.style.top = $0d16028b28e5283f$var$px(cropper.y);
        imgWrapperRef.current.style.bottom = $0d16028b28e5283f$var$px(cropper.y);
    }
    (0, ($parcel$interopDefault($dSH8u$react))).useEffect(()=>{
        if (!node) return;
...
var $0d16028b28e5283f$export$2e2bcd8739ae039 = /*#__PURE__*/ (0, $dSH8u$react.forwardRef)($0d16028b28e5283f$var$SelectionWindow);
